...
\item 
\mbox{\Hypertarget{namespacenlohmann_1_1detail_aa79b12428f716428f3f16b832b8c7822}\label{namespacenlohmann_1_1detail_aa79b12428f716428f3f16b832b8c7822}} 
{\footnotesize template$<$typename Basic\+Json\+Type , typename Key , typename Value , typename  = enable\+\_\+if\+\_\+t$<$not std\+::is\+\_\+constructible$<$                                     typename Basic\+Json\+Type\+::string\+\_\+t, Key$>$\+::value$>$$>$ }\\void {\bfseries from\+\_\+json} (const Basic\+Json\+Type \&j, std\+::map$<$ Key, Value $>$ \&m)
\item 
